...
function createData(title, isActive , edit) {
  return { title, isActive , edit };
}
...
const rows = [
  ...
  createData('Honeycomb', 0),
  createData('Ice cream sandwich', 1),
  createData('Jelly Bean', 1),
  createData('KitKat', 0),
  createData('Lollipop', 0),
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* <TableCell align="right">{row.isActive === 1 ? "Enabled" : "Disabled"}</TableCell> */}
					  <TableCell align="center">
					  {row.isActive === 1 ? 
					  <Button variant="contained" style={{backgroundColor: '#138025', color: 'white'}}>
					  Enabled
					  </Button> : 
					  <Button variant="contained" style={{backgroundColor: '#eb1e1e', color: 'white'}}>
							Disabled
						</Button>}
						
					  </TableCell>
                      <TableCell align="center"><SettingsIcon color="primary"/></TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
